...
<s:form action="employ_update.action" method="post" namespace="/" id="saveForm" theme="simple">
...
<td>性别：</td>
<td><s:radio list="{'boy','girl'}" name="sex" value="%{model.sex}"></s:radio> </td>
</tr>
...
<td>入职时间：</td>
<td><input type="text" name="jointDate" value="<s:date name="model.jointDate" format="yyyy-MM-dd"/>"></td>
</tr>

<tr>
<td>所属部门：</td>

<td><s:select list="list"  name="department.did" value="%{model.department.did}" listKey="did" listValue="dname"/> </td>
<td>编号：</td>
